...
class AdvancedGraphiti(Graphiti):
    """Extended Graphiti client with advanced search capabilities."""
...
async def get_graphiti(settings: SettingsDep):
    """Dependency to get Graphiti client instance."""
    client = AdvancedGraphiti(
...
GraphitiDep = Annotated[AdvancedGraphiti, Depends(get_graphiti)]
